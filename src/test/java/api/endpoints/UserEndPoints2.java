...
//UserEndPoints.java
//Created for perform CRUD Operation(CREATE,READ,UPDATE,DELETE request the user API)
public class UserEndPoints2 {
	// Create method for get the Urls in Property file
	static ResourceBundle getURL() {
		ResourceBundle routes = ResourceBundle.getBundle("route");// Load Property file
		return routes;
	}
